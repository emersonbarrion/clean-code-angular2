...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			{ pattern: "node_modules/@ngrx/**/*.js", included: false, watched: false, served: true },
			{ pattern: "node_modules/@ngrx/**/*.js.map", included: false, watched: false, served: true },
			{ pattern: "node_modules/ng2-translate/**/*.js", included: false, watched: false, served: true },
			...
			{ pattern: "node_modules/cachefactory/**/*.js", included: false, watched: false, served: true },
			{ pattern: "node_modules/cachefactory/**/*.js.map", included: false, watched: false, served: true },
